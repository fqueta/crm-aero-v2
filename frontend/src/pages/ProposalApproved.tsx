  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        if (statusAssinatura !== "aprovado" && statusAssinatura !== "assinado" && !step2Done) {
              ...
              <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 mt-4 text-left">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      navigator.clipboard.writeText((proposal as any).processo_assinatura.signers[0].sign_url);
                  ...
                  <Button
                    ...
                    onClick={() => window.open((proposal as any).processo_assinatura.signers[0].sign_url, "_blank")}
